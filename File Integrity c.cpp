...
int main()
{
    ...
    printf("1.) Want to create a new file ? \n");
    printf("2.) Delete file ?\n");
    printf("3.) Want to edit a file ?\n");
    ...
    // Wait and let the user see the result before terminating the program
    system("pause");
